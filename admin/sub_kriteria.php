...
<div class="container mb-5 pb-5" style="font-family: 'Prompt', sans-serif">
                    ...
                    <form method="post" action="">
                        <div class="card-body">
                            <div class="mb-3 mt-3">
                                ...
                                <input class="form-control" required name="nama_sub_kriteria" type="text" placeholder="Sub Kriteria" aria-label="default input example">
                            </div>
                            <div class="mb-3 mt-3">
                                <label for="bobot_sub_kriteria" class="form-label">Bobot Sub Kriteria</label>
                                <input class="form-control" required name="bobot_sub_kriteria" type="number" placeholder="Bobot Sub Kriteria" aria-label="default input example">
                            </div>
                            <div class="mb-3 mt-3">
                                <label for="id_kriteria" class="form-label">Nama Kriteria</label>
                                <select class="form-select" required id="id_kriteria" name="id_kriteria" aria-label="Default select example">
                                ...
                                <tbody class="table-group-divider">
                                    ...
                                    <?php foreach ($data_SubKriteria as $key => $sub_kriteria) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?= $sub_kriteria['id_sub_kriteria']; ?>">
                                                    Edit
                                                </button>
                                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?= $sub_kriteria['id_sub_kriteria']; ?>">
                                                    Hapus
                                                </button>
                                            </td>
                                        </tr>
    ...
    <?php foreach ($data_SubKriteria as $key => $sub_kriteria) : ?>
        <div class="modal fade" id="edit<?= $sub_kriteria['id_sub_kriteria']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    <form method="post" action="">
                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                <div class="mb-3 mt-3">
                                    <input class="form-control" name="id_sub_kriteria" value="<?= $sub_kriteria['id_sub_kriteria']; ?>" required type="hidden" aria-label="default input example">
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mb-3 mt-3">
                                    <label for="nama_sub_kriteria" class="form-label">Nama Sub Kriteria</label>
                                    <input class="form-control" required name="nama_sub_kriteria" type="text" placeholder="Sub Kriteria" value="<?= $sub_kriteria['nama_sub_kriteria']; ?>" aria-label="default input example">
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mb-3 mt-3">
                                    <label for="bobot_sub_kriteria" class="form-label">Bobot Sub Kriteria</label>
                                    <input class="form-control" value="<?= $sub_kriteria['bobot_sub_kriteria']; ?>" required name="bobot_sub_kriteria" type="number" placeholder="Bobot Sub Kriteria" aria-label="default input example">
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mb-3 mt-3">
                                    ...
                                    <select class="form-select" required id="id_kriteria" name="id_kriteria" aria-label="Default select example">
                                        <option value="">-- Pilih Kriteria --</option>
                                        <?php foreach ($data_Kriteria as $key => $kriteria) : ?>
                                            <option <?= $kriteria['id_kriteria'] == $sub_kriteria['id_kriteria'] ? "selected" : ""; ?> value="<?= $kriteria['id_kriteria']; ?>"><?= $kriteria['nama_kriteria']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
    ...
    <?php foreach ($data_SubKriteria as $sub_kriteria) : ?>
        <div class="modal fade" id="hapus<?= $sub_kriteria['id_sub_kriteria']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="">
                        <div class="modal-header">
