...
<div class="container pt-5" style="font-family: 'Prompt', sans-serif; margin-bottom:130px;">
    <div class="row">
        <div class="d-xxl-flex">
                        ...
                        <form method="post" action="">
                            <div class="card-body">
                                <div class="mb-3 mt-3">
                                    ...
                                    <input class="form-control" maxlength="2" required name="id_kriteria" type="text" placeholder="Kode Kriteria (cth: C1)" aria-label="default input example">
                                </div>
                                <div class="mb-3 mt-3">
                                    <label for="nama_kriteria" class="form-label">Nama Kriteria</label>
                                    <input class="form-control" required name="nama_kriteria" type="text" placeholder="Nama Kriteria" aria-label="default input example">
                                </div>
                                <div class="mb-3 mt-3">
            ...
            <?php endif; ?>
            <div class="<?= mysqli_num_rows($data_Kriteria) < 5 ? "col-xxl-9 ms-xxl-2" : "col-xxl-12 ms-xxl-2 mb-5"; ?> mt-5">
                <div class="card">
                                ...
                                <tbody class="table-group-divider">
                                    ...
                                    <?php foreach ($data_Kriteria as $key => $kriteria) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?= $kriteria['id_kriteria']; ?>">
                                                    Edit
                                                </button>
    ...
    <?php foreach ($data_Kriteria as $key => $kriteria) : ?>
        <div class="modal fade" id="edit<?= $kriteria['id_kriteria']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <form method="post" action="">
                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                <div class="mb-3 mt-3">
                                    <!-- <label for="id_kriteria" class="form-label">Kode Kriteria</label> -->
                                    <input class="form-control" value="<?= $kriteria['id_kriteria']; ?>" required name="id_kriteria" type="hidden" placeholder="Kode Kriteria" aria-label="default input example">
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mb-3 mt-3">
                                    <label for="nama_kriteria" class="form-label">Nama Kriteria</label>
                                    <input class="form-control" value="<?= $kriteria['nama_kriteria']; ?>" required name="nama_kriteria" type="text" placeholder="Nama Kriteria" aria-label="default input example">
                                </div>
                                <div class="mb-3 mt-3">
                                    <label for="keterangan" class="form-label">Keterangan</label>
                                    <select class="form-control" name="keterangan" id="keterangan">
                                        <option value="">-- Pilih --</option>
                                        <option <?= $kriteria['keterangan'] == 'cost' ? 'selected' : ''; ?> value="cost">cost</option>
                                        <option <?= $kriteria['keterangan'] == 'benefit' ? 'selected' : ''; ?> value="benefit">benefit</option>
                                    </select>
                                </div>
                            </div>
    ...
    <?php foreach ($data_Kriteria as $kriteria) : ?>
        <div class="modal fade" id="hapus<?= $kriteria['id_kriteria']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="">
                        <div class="modal-header">
