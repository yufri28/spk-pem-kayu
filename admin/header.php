...
<body>
    <nav class="navbar navbar-expand-lg sticky-top shadow-lg fixed-top" style="background-color: #FF9843" data-bs-theme="dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="font-family: 'Manrope', sans-serif">
                <div class="navbar-nav ms-auto me-auto mt-2 mb-2">
                    <a class="nav-link <?= $_SESSION['menu'] == 'beranda-admin' ? 'active' : ''; ?>" href="index.php">Beranda</a>
                    <a class="nav-link <?= $_SESSION['menu'] == 'alternatif' ? 'active' : ''; ?>" href="alternatif.php">Alternatif</a>
                    <a class="nav-link <?= $_SESSION['menu'] == 'kriteria' ? 'active' : ''; ?>" href="kriteria.php">Kriteria</a>
                    <a class="nav-link <?= $_SESSION['menu'] == 'sub-kriteria' ? 'active' : ''; ?>" href="sub_kriteria.php">Sub
                        Kriteria</a>
                    <!-- <a class="nav-link <?= $_SESSION['menu'] == 'users' ? 'active' : ''; ?>" href="users.php">User</a> -->
                    <a class="nav-link <?= $_SESSION['menu'] == 'hasil' ? 'active' : ''; ?>" href="../auth/logout.php">Logout</a>
                </div>
            </div>
        </div>
    </nav>