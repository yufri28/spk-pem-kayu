...
if (isset($_POST['k'])) {
    ...
    $query->execute();
    $tempat_kayu = $query->get_result();
}
else{
    $tempat_kayu = $koneksi->query("SELECT * FROM alternatif ORDER BY rating DESC");
}
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link fw-bolder" aria-current="page" href="./tempat-kayu.php">Tempat
                                kayu</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="text-center text-lg-start">
            <div class="container col-lg-8" style="margin-top: 10%;">
                <div class="row gx-lg-10 text-center">
                    <div class="title">
                        <h3>SISTEM PENDUKUNG KEPUTUSAN REKOMENDASI TEMPAT kayu DI KABUPATEN TIMOR TENGAH SELATAN</h3>
                    </div>
                </div>
                ...
                <h4 class="" style="margin-top:100px;">Daftar kayu</h4>
                <div class="row list-kayu d-flex justify-content-center mt-2 col-lg-12 col-md-12">
                    <?php foreach ($tempat_kayu as $key => $kayu):?>
                ...
                <?php if(mysqli_num_rows($tempat_kayu) > 6):?>
