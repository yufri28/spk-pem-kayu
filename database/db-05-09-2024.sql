...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Sep 2024 pada 03.52
...
INSERT INTO `alternatif` (`id_alternatif`, `nama_alternatif`, `umur`, `harga`, `gambar`, `nama_mebel`, `latitude`, `longitude`) VALUES
(37, 'Fatunausus', 70, 7000000, 'be730451b23ec3240479ef00a858547a.png', 'MEBEL DIAN JATI', '-10.162626109066125', '123.64503444094763'),
(38, 'Citra ', 34, 3400000, '68feeeb1568c652ae9d2e776aeb0f701.png', 'Depo Mebel', '-10.147574068262093', '123.63374664222953'),
(39, 'Kayu Jati', 34, 1500000, 'b6aa0ce5f58d232ce7ef0a9ab0e3b4ea_1.png', 'Bintang Furniture Center (BFC)', '-10.013223249281467', '123.63130089870384');
...
--
ALTER TABLE `kecocokan_alt_kriteria`
  MODIFY `id_alt_kriteria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=160;
